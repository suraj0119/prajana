  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="bg-white p-5 md:p-8 rounded-lg shadow-md max-w-3xl mx-auto text-center">
        ...
        <p className="font-raleway text-sm md:text-base text-gray-600 mb-6 md:mb-8">
          Click one of the buttons below to proceed to our secure donation platform where you can make your
          contribution. Your support enables us to continue our mission of empowering underprivileged children and
          communities.
        </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
          <Button
            ...
            onClick={() => window.open("https://prajna-foundation.danamojo.org/dm/?utm_campaign=qrcode%5d", "_blank")}
          >
          ...
          <Button
            ...
            className="bg-accent-pink text-primary hover:bg-accent-pink/90 text-base md:text-lg px-6 md:px-10 py-5 md:py-6 h-auto shadow-lg transition-transform hover:scale-105"
            onClick={() =>
              window.open("https://mygoodness.benevity.org/community/cause/356-5761753992061_5957", "_blank")
            }
          >
            <ExternalLink className="mr-2 h-4 w-4 md:h-5 md:w-5" />
