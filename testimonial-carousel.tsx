...
export function TestimonialCarousel() {
  ...
  return (
    <div className="relative mx-auto max-w-4xl">
      <DoodleElement
        className="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 text-[#f4bee9] opacity-50"
        type="circle"
      />
      <DoodleElement
        className="absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2 text-[#f9dc5c] opacity-50"
        type="star"
      />
